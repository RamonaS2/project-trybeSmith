...
export const verifyUsername = (req: Request, res: Response, next: NextFunction) => {
...
export const verifyClasse = (req: Request, res: Response, next: NextFunction) => {
...
export const verifyLevel = (req: Request, res: Response, next: NextFunction) => {
